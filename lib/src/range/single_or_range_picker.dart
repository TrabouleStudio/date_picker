...
///    [RangeDatePicker].
///
class SingleOrRangeDatePicker extends StatefulWidget {
  ...
  @override
  State<SingleOrRangeDatePicker> createState() => _RangeDatePickerState();
}

class _RangeDatePickerState extends State<SingleOrRangeDatePicker> {
  ...
  @override
  void didUpdateWidget(covariant SingleOrRangeDatePicker oldWidget) {
